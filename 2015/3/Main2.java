...
class Main {
	public static void main(String[] args) {
		...
		Set<Point> mySetSanta = new HashSet<Point>();
		Set<Point> mySetNot = new HashSet<Point>();
		int x = 0;
		int y = 0;
		int x_r = 0;
		int y_r = 0;
		mySetSanta.add(new Point(x, y));
		for (int i = 0; i < input.length(); i += 2) {
			...
			mySetNot.add(new Point(x_r, y_r));
		}
		Set<Point> combinedSet = new HashSet<Point>(mySetSanta);
		combinedSet.addAll(mySetNot);
